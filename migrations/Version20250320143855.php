 ...
 */
final class Version20250320143855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre_de_stage (id_offre INT AUTO_INCREMENT NOT NULL, id_pilote INT NOT NULL, id_entreprise INT NOT NULL, titre_offre VARCHAR(255) NOT NULL, description_offre LONGTEXT NOT NULL, duree_stage INT NOT NULL, date_debut_stage DATE NOT NULL, date_fin_stage DATE NOT NULL, salaire DOUBLE PRECISION NOT NULL, statut_offre VARCHAR(50) NOT NULL, INDEX IDX_2A4937874C05E130 (id_pilote), INDEX IDX_2A493787A8937AB7 (id_entreprise), PRIMARY KEY(id_offre)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
